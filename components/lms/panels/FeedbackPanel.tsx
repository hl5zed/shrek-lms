...
export default function FeedbackPanel({ data }: FeedbackPanelProps) {
  return (
    <section className="space-y-3">
      ...
      <div className="grid grid-cols-1 gap-3 lg:h-[500px] lg:grid-cols-[168px_1fr]">
        <div className="lms-scrollbar space-y-1 overflow-y-auto lg:max-h-[500px]">
        ...
        <Card className="lms-shell-card flex min-h-0 flex-col gap-2 p-3">
          ...
          <div className="grid min-h-0 flex-1 grid-cols-1 gap-2 xl:grid-cols-[1.2fr_172px]">
            ...
            <div className="lms-scrollbar min-h-0 space-y-2 overflow-y-auto xl:max-h-[410px]">
